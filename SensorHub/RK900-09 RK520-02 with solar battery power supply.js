...
function lppDecode(bytes) {
	...
	var sensor_types = {
		...
		184: { 'size': 1, 'name': 'capacity', 'signed': false, 'divisor': 1 },
		185: { 'size': 2, 'name': 'DC current', 'signed': false, 'divisor': 100 },
		186: { 'size': 2, 'name': 'DC voltage', 'signed': false, 'divisor': 100 },
		241: { 'size': 2, 'name': '???', 'signed': false, 'divisor': 1 },
	};
	...
	var sensors = [];
	var i = 5;
	var num = (bytes[2] << 12) + (bytes[3] << 4) + bytes[4];  // converts 001f08 to 01f8, for example
